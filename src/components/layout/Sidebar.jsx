...
import { Building2, LayoutDashboard, Settings, Users, GraduationCap, Contact, ClipboardList, CreditCard, BookOpen, FileText, RefreshCw, ScanFace } from 'lucide-react';
...
{ label: 'Face Recognition', path: '/facial-recognition', icon: ScanFace }];
